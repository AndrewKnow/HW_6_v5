...
namespace Tuples
{
    ...
    class PlanetСatalog
    {
        ...
        public static int CallCount { get; set; } // счётчик вызовов метода GetPlanet
        public static (int serialNumber, int equatorLength, string error) GetPlanet(string namePlanet)
        {
